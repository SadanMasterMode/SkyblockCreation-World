...
execute at @e[tag=aots,tag=stage-1] as @e[distance=..2,tag=!spectator] run function sbremake:items/berserk/aots/stage1dmg
execute at @e[tag=aots,tag=stage-2] as @e[distance=..2,tag=!spectator] run function sbremake:items/berserk/aots/stage2dmg
execute at @e[tag=aots,tag=stage-3] as @e[distance=..2,tag=!spectator] run function sbremake:items/berserk/aots/stage3dmg
execute at @e[tag=aots,tag=stage-4] as @e[distance=..2,tag=!spectator] run function sbremake:items/berserk/aots/stage4dmg