...
summon area_effect_cloud ^0.5 ^ ^1 {Passengers:[{id:"minecraft:armor_stand",Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ShowArms:1b,HandItems:[{id:"diamond_axe",Count:1b},{}],DisabledSlots:4144959,Pose:{RightArm:[0f,0f,0f]},Tags:["stage-2","spectator","aots"]}],Radius:0,Duration:2147483647,Tags:["aots","spectator"]}
